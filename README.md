...
You can run this notebook using either Google Colab or locally with Jupyter.

### ✅ Option 1: Google Colab
1. Upload `Credit_Case_study.ipynb` to Google Colab  
2. Upload dataset files downloaded from Kaggle  
3. Run all cells sequentially  

### ✅ Option 2: Jupyter Notebook (Local Setup)
...
- Develop credit risk scoring model  
- Create interactive dashboard (Power BI / Streamlit)  
- Deploy as an end-to-end ML pipeline  
